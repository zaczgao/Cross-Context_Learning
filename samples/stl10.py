...
if __name__ == '__main__':
    from configs.moco.stl10cfg import STL10Config

    cfg = STL10Config("pretrain")
    train_dataset = STL10(cfg.DATA["root"], split="train")
    test_dataset = STL10(cfg.DATA["root"], split="test")
